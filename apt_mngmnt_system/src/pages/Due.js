...
import {AddDueModal} from '../component/AddDueModal';
import {EditDueModal} from '../component/EditDueModal';
...
export class Due extends Component {
    ...
    refreshList() {
        fetch(process.env.REACT_APP_API + 'AptDueBills')
            ...
            <div >
                <MainHeaderAdmin />
                  <ButtonToolbar>
                    ...
                    <AddDueModal show={this.state.addModalShow}
                                ...
                                <td> 
                                    <ButtonToolbar>
                                         <Button className="mr-2" variant="info"
                                          ...
                                          <EditDueModal show={this.state.editModalShow}
